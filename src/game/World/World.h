...
enum WorldBoolConfigs
{
	...
	CONFIG_CUSTOM_RULES, //Custom
	CONFIG_CUSTOM_RESISTANCES, //Custom
	CONFIG_CUSTOM_RANDOMIZE_ITEM,
	CONFIG_CUSTOM_ADVENTURE_MODE, //end custom
	CONFIG_DEVELOPER_BUILD_ENABLED,
...
enum WorldFloatConfigs
{
	...
	CONFIG_CUSTOM_RANDOMIZE_ITEM_CHANCE, //custom
...
enum WorldIntConfigs
{
	...
	CONFIG_CUSTOM_RANDOMIZE_ITEM_MIN_LEVEL, //custom
	CONFIG_CUSTOM_RANDOMIZE_ITEM_DIFF,
	CONFIG_CUSTOM_RANDOMIZE_ITEM_MIN_QUALITY,
	CONFIG_CUSTOM_ADVENTURE_MAX_LEVEL,
	CONFIG_CUSTOM_ADVENTURE_PVPXP,
	CONFIG_CUSTOM_ADVENTURE_KILLXP,
	CONFIG_CUSTOM_ADVENTURE_BOSSONLYXP,
	CONFIG_CUSTOM_ADVENTURE_LEVELXP,
	CONFIG_CUSTOM_ADVENTURE_DEATHXP,
	CONFIG_CUSTOM_ADVENTURE_ITEMXP, //end custom
